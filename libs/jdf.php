  ...
  public function jdate($format, $timestamp = '', $none = '', $time_zone = 'Asia/Tehran', $tr_num = 'fa')
  {
    ...
    for ($i = 0; $i < $sl; $i++) {
      ...
      switch ($sub) {
        ...
        case 'D':
          $out .= $this->tr_num(array('kh' => $date[7]), ' ');
          break;

        case 'f':
          $out .= $this->tr_num(array('ff' => $j_m), ' ');
          break;

        case 'F':
          $out .= $this->tr_num(array('mm' => $j_m), ' ');
          break;
        ...
        case 'l':
          $out .= $this->tr_num(array('rh' => $date[7]), ' ');
          break;
        ...
        case 'r':
          $key = $this->tr_num(array('rh' => $date[7], 'mm' => $j_m));
        ...
        case 'v':
          $out .= $this->tr_num(array('ss' => ($j_y % 100)), ' ');
          break;

        case 'V':
          $out .= $this->tr_num(array('ss' => $j_y), ' ');
          break;
  ...
  public function jstrftime($format, $timestamp = '', $none = '', $time_zone = 'Asia/Tehran', $tr_num = 'fa')
  {
    ...
    for ($i = 0; $i < $sl; $i++) {
      ...
      switch ($sub) {
          ...
          /* Day */
        case 'a':
          $out .= $this->tr_num(array('kh' => $date[6]), ' ');
          break;

        case 'A':
          $out .= $this->tr_num(array('rh' => $date[6]), ' ');
          break;
        ...
        case 'c':
          $key = $this->tr_num(array('rh' => $date[6], 'mm' => $j_m));
